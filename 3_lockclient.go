...
func (ck *Clerk) TryLock(lockname uint64) bool {
	return ck.client.MakeRequest(ck.primary.TryLock, RPCArgs{Arg1:lockname, Arg2:0}) != 0
}
...
func (ck *Clerk) Unlock(lockname uint64) bool {
	return ck.client.MakeRequest(ck.primary.Unlock, RPCArgs{Arg1:lockname, Arg2:0}) != 0
}
